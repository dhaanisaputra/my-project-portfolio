...
const Contacts = () => {
  ...
  return (
    <div
      id="contact"
      className="min-h-screen bg-[#09101a] pt-[4rem] md:pt-[8rem] flex flex-col justify-center sm:py-12"
    >
        ...
        <div className="relative px-6 py-10 bg-indigo-400 shadow-lg sm:rounded-3xl sm:p-16 flex flex-col md:flex-row md:items-start w-full">
          ...
          <div className="md:w-1/2 w-full mt-8 md:mt-0 mb-8 md:mb-0 sm:mb-10">
            ...
            >
              ...
              />
              <input
                className="shadow bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer"
                type="submit"
                value="Send ➤"
              />
            </form>
